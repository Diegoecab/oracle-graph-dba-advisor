...
El skill no debe limitarse a decir "crear indices invisibles y comparar". En la
seccion de recomendacion debe entregar un paso a paso ejecutable como este,
antes del `Recommendation Summary` final:

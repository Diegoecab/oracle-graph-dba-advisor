...
CREATE USER MYSCHEMA IDENTIFIED BY "FraudDemo#2026X"
...
-- For the advisor to query V$ / DBA_* metadata in managed environments
-- (including ADB), prefer the catalog role instead of direct V_$ grants.
GRANT SELECT_CATALOG_ROLE TO MYSCHEMA;
GRANT EXECUTE ON DBMS_XPLAN TO MYSCHEMA;
